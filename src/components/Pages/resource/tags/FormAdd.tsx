...
export default function FormAdd() {
  ...
  const { addTag, loading, error } = useAddTags();
  ...
  async function onSubmit(data: Category) {
    const success = await addTag(data); // Firebase se encargará de generar el id automáticamente

    if (success) {
      toast({
        title: "Tag añadida correctamente",
